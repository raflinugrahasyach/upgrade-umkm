...
import { ArrowLeft, Calendar, Clock, MapPin, Share2, Ticket, CheckCircle2 } from "lucide-react";
...
export default function EventDetailPage() {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center"><div className="animate-spin w-10 h-10 border-4 border-blue-600 border-t-transparent rounded-full"></div></div>;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
                <div className="bg-white rounded-3xl p-6 shadow-xl border border-zinc-100 sticky top-24">
                    <img src={evt.image_url} className="w-full rounded-2xl mb-6 shadow-sm" alt="Flyer"/>
                    
                    <button className="w-full py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold rounded-xl shadow-lg shadow-orange-500/30 hover:scale-[1.02] transition-transform mb-4">
                        Daftar Sekarang
                    </button>
                    ...
                    <div className="border-t border-zinc-100 pt-6">
                        ...
                        <div className="flex justify-center gap-4">
                             {/* Dummy Share Buttons */}
                             <div className="w-10 h-10 bg-zinc-100 rounded-full flex items-center justify-center hover:bg-zinc-200 cursor-pointer">FB</div>
                             <div className="w-10 h-10 bg-zinc-100 rounded-full flex items-center justify-center hover:bg-zinc-200 cursor-pointer">WA</div>
                             <div className="w-10 h-10 bg-zinc-100 rounded-full flex items-center justify-center hover:bg-zinc-200 cursor-pointer">IG</div>
                        </div>
                    </div>
                </div>
            </div>
